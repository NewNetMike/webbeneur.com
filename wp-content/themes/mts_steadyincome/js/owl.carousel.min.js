...
var itemsNum = Math.min(owl.find('.item').length, 5);
	...
	$('.slide-first-img').imagesLoaded(function() {
		...
		if ( jQuery('#owl-demo').length ) {
			jQuery('#owl-demo').each(function() {
				var primarySlider = jQuery(this),
					primarySliderContainer = primarySlider.closest('.footer_featured');
				...
				$(".footer-next").click(function(){
                   primarySlider.trigger('next.owl.carousel');
                })
                $(".footer-prev").click(function(){
                   primarySlider.trigger('prev.owl.carousel');
                })
			});
		}
	});
