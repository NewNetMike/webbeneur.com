...
class mtsGoogleTypography {
	...
	function help_tab() {
		...
		$adding_title					= __('Adding A Collection', 'steadyincome' );
		$adding_content				= '<p>'.__('To add a new font for use on your site. Click the "Add New" button on the top left of the page near the "Google Typography" title.', 'steadyincome' ).'</p>';
		$adding_content			 .= '<p>'.__('Once added, a new font row will appear on the page below. Next you can continue to customize your font (more info in the "Customizing" help tab).', 'steadyincome' ).'</p>';
		//$adding_content			 .= '<p><a href="https://vimeo.com/67957799" target="_blank">'.__('Watch The Video Tutorial &rarr;', 'steadyincome' ).'</a></p>';
		$customizing_title 		= __('Customizing', 'steadyincome' );
		$customizing_content	= '<p>'.__('Customizing fonts is easy; after adding a new font row you can then customize the following font attributes:', 'steadyincome' ).'</p>';
		$customizing_content .= '<ul><li><b>'.__('Preview Text', 'steadyincome' ).'</b> - '.__('Used for live previewing your changes. This text does not appear anywhere on your website.', 'steadyincome' ).'</li><li><b>Preview Background Color</b> - Allows you to swap between light and dark backgrounds when previewing this font.</li><li><b>'.__('Font Family', 'steadyincome' ).'</b> - '.__('The font family to use for this font. Choose from a real-time list of all available Google Fonts.', 'steadyincome' ).'</li><li><b>'.__('Font Variant', 'steadyincome' ).'</b> - '.__('The variant to use for this font. Note: Each font has it\'s own variant options.', 'steadyincome' ).'</li><li><b>'.__('Font Size', 'steadyincome' ).'</b> - '.__('The size you would like this font to be.', 'steadyincome' ).'</li><li><b>'.__('Font Color', 'steadyincome' ).'</b> - '.__('The color you\'d like to use for this font.', 'steadyincome' ).'</li><li><b>'.__('CSS Selectors', 'steadyincome' ).'</b> - '.__('The HTML tags or CSS selectors you\'d like this font to apply to (more info in the "CSS Selectors" help tab). You can specify multiple selectors separated by comma\'s. Ex: h1, #some_id, .some_class', 'steadyincome' ).'</li></ul>';
		$selectors_title 			= __('CSS Selectors', 'steadyincome' );
		$selectors_content		= '<p>' . __('CSS Selectors are used to hook your font rows into your actual website. Once you\'ve added, customized, and defined CSS selectors for your fonts, Google Typography will automatically insert all the necessary CSS into your website.', 'steadyincome' ) . '</p>';
		$selectors_content		= '<p>' . __('Here are some examples of the selectors you can use:', 'steadyincome' ) . '</p>';
		$selectors_content	 .= '<ul><li><b>'.__('IDs', 'steadyincome' ).':</b> '.__('#selector', 'steadyincome' ).'</li><li><b>'.__('Classes:', 'steadyincome' ).':</b> '.__('.selector', 'steadyincome' ).'</li><li><b>'.__('HTML Tags', 'steadyincome' ).':</b> '.__('span', 'steadyincome' ).'</ul>';
		$selectors_content	 .= '<p><b>'.__('Example', 'steadyincome' ).':</b> '.__('#selector span.date', 'steadyincome' ).'</p>';
	...
	function plugin_link($links, $file) {
		if ( $file == 'google-typography/google-typography.php' ) {
			$links['settings'] = sprintf( '<a href="%s"> %s </a>', admin_url( 'themes.php?page=typography' ), __( 'Settings', 'steadyincome' ) );
		}
		return $links;
	}
	...
	function options_ui() {
		...
		$title								= __('Theme Typography', 'steadyincome' );
		$loading							= __('Loading Your Collections', 'steadyincome' );
		$add_new        			= __('Add New Collection', 'steadyincome' );
		$reset        				= __('Reset Collections', 'steadyincome' );
		$preview_text   			= __('Type in some text to preview...', 'steadyincome' );
		$collection_title 			= __('New Collection', 'steadyincome' );
        //$this->preview_text = $preview_text; // to pass it to JS
		$preview_hint   			= __('Preview Background Color', 'steadyincome' );
		//$font_family_title  	= __('Font family...', 'steadyincome' );
        $std_font_family_title  	= __('Standard Fonts', 'steadyincome' );
        $google_font_family_title  	= __('Google Fonts', 'steadyincome' );
		$font_variant_title 	= __('Variant...', 'steadyincome' );
		$font_size_title 			= __('Size...', 'steadyincome' );
        $backup_font_title          = __('Fallback:', 'steadyincome' );
		$css_selectors_title	= __('CSS Selectors:', 'steadyincome' );
        $additional_css_title	= __('Additional CSS:', 'steadyincome' );
		$delete_button_text   = __('Delete', 'steadyincome' );
		$save_button_text			= __('Save', 'steadyincome' );
		
		$welcome_title 				= __('Theme Typography', 'steadyincome' );
		$welcome_subtitle			= __('Get started in 3 steps.', 'steadyincome' );//.'<a href="https://vimeo.com/67957799" target="_blank">'.__('Watch the video tutorial &#x2192;', 'steadyincome' ).'</a>';
		$step_1_title 				= __('1. Pick A Font', 'steadyincome' );
		$step_1_desc					= __('Choose from any of the 600+ Google Fonts.', 'steadyincome' );
		$step_2_title 				= __('2. Customize It', 'steadyincome' );
		$step_2_desc					= __('Pick a size, variant, color and more.', 'steadyincome' );
		$step_3_title 				= __('3. Attach It', 'steadyincome' );
		$step_3_desc					= __('Attach your font to any CSS selector(s).', 'steadyincome' );
		$year									= date("Y");
        $themename = MTS_THEME_NAME;
        
        $character_sets_title = __('Character sets', 'steadyincome' );
        $character_sets_desc = __('Choose the character sets you wish to include. Please note that not all sets are available for all fonts.', 'steadyincome' );
        ...
        $character_sets = array(
            'latin' => __('Latin', 'steadyincome' ),
            'latin-ext' => __('Latin Extended', 'steadyincome' ),
            'cyrillic' => __('Cyrillic', 'steadyincome' ),
            'cyrillic-ext' => __('Cyrillic Extended', 'steadyincome' ),
            'greek' => __('Greek', 'steadyincome' ),
            'greek-ext' => __('Greek Extended', 'steadyincome' ),
            'vietnamese' => __('Vietnamese', 'steadyincome' ),
            'khmer' => __('Khmer', 'steadyincome' ),
            'devanagari' => __('Devanagari', 'steadyincome' ),
        );
...
EOT;
	...
	function admin_scripts() {
		...
		wp_localize_script('google-typography', 'googletypography', array(
	            'reset_confirm' => __("Are you sure you want to revert to the theme's default collections? Note: You will lose any custom collections you've created.", 'steadyincome' ),
	            'delete_confirm' => __("Are you sure you want to delete this collection?", 'steadyincome' )
	        ));
