<div class="wrap">
  <h2><?php _e('Easy Smooth Scroll Links Setting', 'e-s-s-l' ); ?></h2>

  <ul> 	
    <li>
      <a href="http://www.jeriffcheng.com/wordpress-plugins/easy-smooth-scroll-links" target="_blank" rel="noopener"><?php _e('Documents and Troubleshooting', 'e-s-s-l' ); ?>
      </a>
    </li> 	
    <li>
      <a href="https://wordpress.org/support/plugin/easy-smooth-scroll-links" target="_blank" rel="noopener"><?php _e('Support Forum on WordPress.org', 'e-s-s-l' ); ?>
      </a>
    </li>
  </ul>    
  <?php screen_icon(); ?> 	
        ...
        <tr>			 
          <td style="padding:5px;font-family:Verdana, Geneva, sans-serif;color:#666;">                 
            <label for="essl_speed">                     
              <p><?php _e('Scroll Speed ( smaller number, faster, default is 900 )', 'e-s-s-l' ); ?>
              </p>                     
              <p>
        ...
        <tr>			 
          <td style="padding:5px;font-family:Verdana, Geneva, sans-serif;color:#666;">                 
            <label for="essl_offset">                     
              <p><?php _e('Offset ( default is 20 )', 'e-s-s-l' ); ?>
              </p>                     
              <p>
        ...
        <tr>			 
          <td style="padding:5px;font-family:Verdana, Geneva, sans-serif;color:#666;">                 
            <label for="essl_easing">                     
              <p><?php _e('Scrolling Animation Effects ( default is easeInQuint ) ', 'e-s-s-l' ); ?>
              </p>                     
              <p>
                <select name="essl_easing">    
                  <option disabled="disabled" ><?php _e('Choose an Animation Effects', 'e-s-s-l' ); ?>
                  </option>    
...
<tr>  	
  <td style="padding:5px;font-family:Verdana, Geneva, sans-serif;color:#666;">            			
    <label for="essl_exclude_begin">
      <p><?php _e('Exclude Anchors Beginning With ( default is #tab   #quicktab  #pane )	', 'e-s-s-l' ); ?>			
      </p> 				
...
<tr>  	
  <td style="padding:5px;font-family:Verdana, Geneva, sans-serif;color:#666;">                 		
    <label for="essl_offset">
      <p><?php _e('Exclude Anchors Exactly Match', 'e-s-s-l' ); ?>
      </p>			
      <p>			
...
<tr>	
  <td style="padding:25px;font-family:Verdana, Geneva, sans-serif;color:#666;">	 		
    <label>
      <strong><?php _e('Enable Scrolling from One Page to Another ?', 'e-s-s-l' ); ?>
      </strong> 
    </label>
    <input type="checkbox" name="enable_essl_aggressive" value="1"
           <?php checked(1,get_option('enable_essl_aggressive'));?> />
    <br> 
    <strong><?php _e('Warning', 'e-s-s-l' ); ?>
    </strong>:<?php _e(' This feature is experimental, might cause conflict with some slider plugins, or blank pages.', 'e-s-s-l' ); ?>	
  </td>
</tr>		   		
</tbody>				
<tfoot>		   
