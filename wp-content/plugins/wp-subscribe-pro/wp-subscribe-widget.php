...
/*-----------------------------------------------------------------------------------*/
    ...
    function widget( $args, $instance ) {
        ...
        ?>
            ...
            <div class="wp-subscribe<?php echo $name_class; ?>" id="wp-subscribe" style="background: <?php echo $instance['background_color']; ?>;" data-thanks_page="<?php echo (int) $instance['thanks_page']; ?>" data-thanks_page_url="<?php echo $instance['thanks_page_url']; ?>" data-thanks_page_new_window="<?php echo 0; /* (int) $instance['thanks_page_new_window']; */ ?>">
                ...
                <?php } elseif ($instance['service'] == 'mailchimp') { ?>
                    ...
                    <form action="<?php echo add_query_arg('mailchimp_signup', '1', $current_url); ?>" method="post" class="wp-subscribe-form wp-subscribe-mailchimp" id="wp-subscribe-form-<?php echo $wp_subscribe_forms; ?>">
                        ...
                        <form method="post" action="https://www.aweber.com/scripts/addlead.pl" target="_blank" class="wp-subscribe-form wp-subscribe-aweber" id="wp-subscribe-form-<?php echo $wp_subscribe_forms; ?>">
                ...
                <?php } elseif ($instance['service'] == 'getresponse') { ?>
                    ...
                    } elseif ($instance['service'] == 'mailerlite') { ?>
                    
                    <form action="<?php echo add_query_arg('mailerlite_signup', '1', $current_url); ?>" method="post" class="wp-subscribe-form wp-subscribe-mailerlite" id="wp-subscribe-form-<?php echo $wp_subscribe_forms; ?>">
                        <?php if (!empty($instance['include_name_field'])) { ?>
                        <input class="name-field" type="text" value="" placeholder="<?php echo $instance['name_placeholder']; ?>" name="mailerlite_name" style="background: <?php echo $instance['field_background_color']; ?>; color: <?php echo $instance['field_text_color']; ?>">
                        <?php } ?>
                        <input class="email-field" type="text" value="" placeholder="<?php echo $instance['email_placeholder']; ?>" name="mailerlite_email" style="background: <?php echo $instance['field_background_color']; ?>; color: <?php echo $instance['field_text_color']; ?>">
                        <input class="submit" name="submit" type="submit" value="<?php echo $instance['button_text']; ?>" style="background: <?php echo $instance['button_background_color']; ?>; color: <?php echo $instance['button_text_color']; ?>">
                        <input type="hidden" name="widget_id" value="<?php echo $this->id ?>" />
                        <?php if (!empty($instance['from_popup'])) { ?>
                            <input type="hidden" name="from_popup" value="1" />
                    ...
                    } elseif ($instance['service'] == 'benchmark') { ?>
                    
                    <form action="<?php echo add_query_arg('benchmark', '1', $current_url); ?>" method="post" class="wp-subscribe-form wp-subscribe-benchmark" id="wp-subscribe-form-<?php echo $wp_subscribe_forms; ?>">
                        <?php if (!empty($instance['include_name_field'])) { ?>
                        <input class="name-field" type="text" value="" placeholder="<?php echo $instance['name_placeholder']; ?>" name="benchmark_name" style="background: <?php echo $instance['field_background_color']; ?>; color: <?php echo $instance['field_text_color']; ?>">
                        <?php } ?>
                        <input class="email-field" type="text" value="" placeholder="<?php echo $instance['email_placeholder']; ?>" name="benchmark_email" style="background: <?php echo $instance['field_background_color']; ?>; color: <?php echo $instance['field_text_color']; ?>">
                        <input class="submit" name="submit" type="submit" value="<?php echo $instance['button_text']; ?>" style="background: <?php echo $instance['button_background_color']; ?>; color: <?php echo $instance['button_text_color']; ?>">
                        <input type="hidden" name="widget_id" value="<?php echo $this->id ?>" />
                        <?php if (!empty($instance['from_popup'])) { ?>
                            <input type="hidden" name="from_popup" value="1" />
                    ...
                    } elseif ($instance['service'] == 'constantcontact') { ?>
                    
                    <form action="<?php echo add_query_arg('constantcontact', '1', $current_url); ?>" method="post" class="wp-subscribe-form wp-subscribe-constantcontact" id="wp-subscribe-form-<?php echo $wp_subscribe_forms; ?>">
                        <?php if (!empty($instance['include_name_field'])) { ?>
                        <input class="name-field" type="text" value="" placeholder="<?php echo $instance['name_placeholder']; ?>" name="constantcontact_name" style="background: <?php echo $instance['field_background_color']; ?>; color: <?php echo $instance['field_text_color']; ?>">
                        <?php } ?>
                        <input class="email-field" type="text" value="" placeholder="<?php echo $instance['email_placeholder']; ?>" name="constantcontact_email" style="background: <?php echo $instance['field_background_color']; ?>; color: <?php echo $instance['field_text_color']; ?>">
                        <input class="submit" name="submit" type="submit" value="<?php echo $instance['button_text']; ?>" style="background: <?php echo $instance['button_background_color']; ?>; color: <?php echo $instance['button_text_color']; ?>">
                        <input type="hidden" name="widget_id" value="<?php echo $this->id ?>" />
                        <?php if (!empty($instance['from_popup'])) { ?>
                            <input type="hidden" name="from_popup" value="1" />
                    ...
                    } elseif ($instance['service'] == 'mailrelay') { ?>
                    
                    <form action="<?php echo add_query_arg('mailrelay', '1', $current_url); ?>" method="post" class="wp-subscribe-form wp-subscribe-mailrelay" id="wp-subscribe-form-<?php echo $wp_subscribe_forms; ?>">
                        <?php if (!empty($instance['include_name_field'])) { ?>
                        <input class="name-field" type="text" value="" placeholder="<?php echo $instance['name_placeholder']; ?>" name="mailrelay_name" style="background: <?php echo $instance['field_background_color']; ?>; color: <?php echo $instance['field_text_color']; ?>">
                        <?php } ?>
                        <input class="email-field" type="text" value="" placeholder="<?php echo $instance['email_placeholder']; ?>" name="mailrelay_email" style="background: <?php echo $instance['field_background_color']; ?>; color: <?php echo $instance['field_text_color']; ?>">
                        <input class="submit" name="submit" type="submit" value="<?php echo $instance['button_text']; ?>" style="background: <?php echo $instance['button_background_color']; ?>; color: <?php echo $instance['button_text_color']; ?>">
                        <input type="hidden" name="widget_id" value="<?php echo $this->id ?>" />
                        <?php if (!empty($instance['from_popup'])) { ?>
                            <input type="hidden" name="from_popup" value="1" />
...
/*-----------------------------------------------------------------------------------*/
    ...
    function form( $instance ) {
        ...
        <?php $this->output_select_field('service', __('Service:', 'wp-subscribe'), array('feedburner' => 'FeedBurner', 'mailchimp' => 'MailChimp', 'aweber' => 'AWeber', 'getresponse' => 'GetResponse', 'mailerlite' => 'MailerLite', 'benchmark' => 'BenchmarkEmail', 'constantcontact' => 'Constant Contact', 'mailrelay' => 'MailRelay'), $instance['service']); ?>
        ...
        <div class="wp_subscribe_account_details_mailerlite" style="display: none;">
            <?php $this->output_text_field('mailerlite_api_key', __('MailerLite API key', 'wp-subscribe'), $instance['mailerlite_api_key']); ?>
            <a href="https://kb.mailerlite.com/does-mailerlite-offer-an-api/" target="_blank"><?php _e('Find your API key', 'wp-subscribe'); ?></a>
            <?php $this->output_text_field('mailerlite_list_id', __('MailerLite list ID', 'wp-subscribe'), $instance['mailerlite_list_id']); ?>
            <a href="https://kb.mailerlite.com/does-mailerlite-offer-an-api/" target="_blank"><?php _e('Find your list ID', 'wp-subscribe'); ?></a>
        </div><!-- .wp_subscribe_account_details_mailerlite -->
        <div class="wp_subscribe_account_details_benchmark" style="display: none;">
            <?php $this->output_text_field('benchmark_user', __('BenchmarkEmail Username', 'wp-subscribe'), $instance['benchmark_user']); ?>
            <?php $this->output_password_field('benchmark_pass', __('BenchmarkEmail Password', 'wp-subscribe'), $instance['benchmark_pass']); ?>
            <?php $this->output_text_field('benchmark_list_name', __('BenchmarkEmail list name', 'wp-subscribe'), $instance['benchmark_list_name']); ?>
        </div><!-- .wp_subscribe_account_details_benchmark -->
        <div class="wp_subscribe_account_details_constantcontact" style="display: none;">
            <?php $this->output_text_field('constantcontact_api_key', __('Constant Contact API key', 'wp-subscribe'), $instance['constantcontact_api_key']); ?>
            <?php $this->output_text_field('constantcontact_token', __('Constant Contact access token', 'wp-subscribe'), $instance['constantcontact_token']); ?>
            <a href="http://support2.constantcontact.com/articles/FAQ/1388" target="_blank"><?php _e('Find your API key & access token', 'wp-subscribe'); ?></a>
            <?php $this->output_text_field('constantcontact_list_id', __('Constant Contact List ID', 'wp-subscribe'), $instance['constantcontact_list_id']); ?>
            <a href="https://community.constantcontact.com/t5/Getting-Started-with-API-s/How-to-find-the-list-ID-for-your-contact-lists/td-p/185302" target="_blank"><?php _e('Find your list ID', 'wp-subscribe'); ?></a>
        </div><!-- .wp_subscribe_account_details_constantcontact -->
        <div class="wp_subscribe_account_details_mailrelay" style="display: none;">
            <?php $this->output_text_field('mailrelay_api_key', __('MailRelay API key', 'wp-subscribe'), $instance['mailrelay_api_key']); ?>
            <?php $this->output_text_field('mailrelay_host', __('MailRelay host address', 'wp-subscribe'), $instance['mailrelay_host']); ?>
            <?php $this->output_text_field('mailrelay_group_id', __('MailRelay Subscribers Group ID', 'wp-subscribe'), $instance['mailrelay_group_id']); ?>
        </div><!-- .wp_subscribe_account_details_mailrelay -->
        ...
        <div class="wp_subscribe_thanks_page">
            ...
            <label>
                ...
                <?php _e( 'Show Thank You Page after successful subscription', 'wp-subscribe' ); ?>
            </label>
            <div class="wp_subscribe_thanks_page_details">
                <?php $this->output_text_field('thanks_page_url', __('Thank You Page URL', 'wp-subscribe'), $instance['thanks_page_url']); ?>
                <!-- <label>
                    <input type="hidden" name="<?php echo $this->get_field_name('thanks_page_new_window'); ?>" value="0">
                    <input id="<?php echo $this->get_field_id('thanks_page_new_window'); ?>" type="checkbox" class="thanks-page-new-window-field" name="<?php echo $this->get_field_name('thanks_page_new_window'); ?>" value="1" <?php checked($instance['thanks_page_new_window']); ?>>
                    <?php _e( 'Open in new window', 'wp-subscribe' ); ?>
                </label> -->
            </div>
        </div>
    ...
    public function output_password_field($setting_name, $setting_label, $setting_value) {
        ?>
