	    		...
	    		<div class="wp-subscribe-field" id="wp-subscribe-form-options"<?php echo $options['popup_content'] != 'subscribe_form' ? ' style="display: none;"' : ''; ?>>
	    			<div class="wp-subscribe-field">
						<select name="wp_subscribe_options[popup_form_options][service]" id="popup_form_service" class="services_dropdown">
							...
							<option value="mailerlite" <?php selected( $options['popup_form_options']['service'], 'mailerlite' ); ?>>MailerLite</option>
							<option value="benchmark" <?php selected( $options['popup_form_options']['service'], 'benchmark' ); ?>>BenchmarkEmail</option>
							<option value="constantcontact" <?php selected( $options['popup_form_options']['service'], 'constantcontact' ); ?>>Constant Contact</option>
							<option value="mailrelay" <?php selected( $options['popup_form_options']['service'], 'mailrelay' ); ?>>MailRelay</option>
						</select>
					</div>
					<div class="wp_subscribe_account_details">
						...
						<div class="wp_subscribe_account_details_mailerlite" style="display: none;">
		        			<?php wp_subscribe_options_text_field('mailerlite_api_key', __('MailerLite API Key', 'wp-subscribe'), 'popup_form_options'); ?>
							<?php wp_subscribe_options_text_field('mailerlite_list_id', __('MailerLite List ID', 'wp-subscribe'), 'popup_form_options'); ?>
							<p class="clear"><a href="https://kb.mailerlite.com/does-mailerlite-offer-an-api/" target="_blank"><?php _e('Find your API key', 'wp-subscribe'); ?></a> | 
	            			<a href="https://kb.mailerlite.com/does-mailerlite-offer-an-api/" target="_blank"><?php _e('Find your list ID', 'wp-subscribe'); ?></a></p>
						</div><!-- .wp_subscribe_account_details_mailerlite -->
						<div class="wp_subscribe_account_details_benchmark" style="display: none;">
		        			<?php wp_subscribe_options_text_field('benchmark_user', __('BenchmarkEmail Username', 'wp-subscribe'), 'popup_form_options'); ?>
		        			<?php wp_subscribe_options_password_field('benchmark_pass', __('BenchmarkEmail Password', 'wp-subscribe'), 'popup_form_options'); ?>
							<?php wp_subscribe_options_text_field('benchmark_list_name', __('BenchmarkEmail List Name', 'wp-subscribe'), 'popup_form_options'); ?>
						</div><!-- .wp_subscribe_account_details_benchmark -->
						<div class="wp_subscribe_account_details_constantcontact" style="display: none;">
		        			<?php wp_subscribe_options_text_field('constantcontact_api_key', __('Constant Contact API key', 'wp-subscribe'), 'popup_form_options'); ?>
		        			<?php wp_subscribe_options_text_field('constantcontact_token', __('Constant Contact access token', 'wp-subscribe'), 'popup_form_options'); ?>
							<?php wp_subscribe_options_text_field('constantcontact_list_id', __('Constant Contact List ID', 'wp-subscribe'), 'popup_form_options'); ?>
							<p class="clear"><a href="http://support2.constantcontact.com/articles/FAQ/1388" target="_blank"><?php _e('Find your API key & access token', 'wp-subscribe'); ?></a> | 
	            			<a href="https://community.constantcontact.com/t5/Getting-Started-with-API-s/How-to-find-the-list-ID-for-your-contact-lists/td-p/185302" target="_blank"><?php _e('Find your list ID', 'wp-subscribe'); ?></a></p>
						</div><!-- .wp_subscribe_account_details_constantcontact -->
						<div class="wp_subscribe_account_details_mailrelay" style="display: none;">
		        			<?php wp_subscribe_options_text_field('mailrelay_api_key', __('MailRelay API key', 'wp-subscribe'), 'popup_form_options'); ?>
		        			<?php wp_subscribe_options_text_field('mailrelay_host', __('MailRelay host address', 'wp-subscribe'), 'popup_form_options'); ?>
							<?php wp_subscribe_options_text_field('mailrelay_group_id', __('MailRelay Subscribers Group ID', 'wp-subscribe'), 'popup_form_options'); ?>
					...
					<div class="wp-subscribe-field wp_subscribe_thanks_page">
			            ...
			            <label>
			                <input id="wp_subscribe_popup_form_thanks_page" type="checkbox" class="thanks-page-field" name="wp_subscribe_options[popup_form_options][thanks_page]" value="1" <?php checked($options['popup_form_options']['thanks_page']); ?>>
			                <?php _e( 'Show Thank You Page after successful subscription', 'wp-subscribe' ); ?>
			            </label>
			            <div class="wp_subscribe_thanks_page_details">
			                <?php wp_subscribe_options_text_field('thanks_page_url', __('Thank You Page URL', 'wp-subscribe'), 'popup_form_options'); ?>
			            </div>
			        </div>
				...
				<div id="wp-subscribe-single-options"<?php echo !$options['enable_single_post_form'] ? ' style="display: none;"' : ''; ?>>
					...
					<p class="wp-subscribe-field">
						<select name="wp_subscribe_options[single_post_form_options][service]" id="single_post_form_service" class="services_dropdown">
							...
							<option value="mailerlite" <?php selected( $options['single_post_form_options']['service'], 'mailerlite' ); ?>>MailerLite</option>
							<option value="benchmark" <?php selected( $options['single_post_form_options']['service'], 'benchmark' ); ?>>BenchmarkEmail</option>
							<option value="constantcontact" <?php selected( $options['single_post_form_options']['service'], 'constantcontact' ); ?>>Constant Contact</option>
							<option value="mailrelay" <?php selected( $options['single_post_form_options']['service'], 'mailrelay' ); ?>>MailRelay</option>
						</select>
					</p>
					<div class="wp_subscribe_account_details">
	   					<div class="wp_subscribe_account_details_feedburner" style="display: none;">
						...
						<div class="wp_subscribe_account_details_mailerlite" style="display: none;">
		        			<?php wp_subscribe_options_text_field('mailerlite_api_key', __('MailerLite API Key', 'wp-subscribe'), 'single_post_form_options'); ?>
							<?php wp_subscribe_options_text_field('mailerlite_list_id', __('MailerLite list ID', 'wp-subscribe'), 'single_post_form_options'); ?>
	            			<p class="clear"><a href="https://kb.mailerlite.com/does-mailerlite-offer-an-api/" target="_blank"><?php _e('Find your API key', 'wp-subscribe'); ?></a> | 
	            			<a href="#" target="_blank"><?php _e('Find your list ID', 'wp-subscribe'); ?></a></p>
						</div><!-- .wp_subscribe_account_details_mailerlite -->

						<div class="wp_subscribe_account_details_benchmark" style="display: none;">
		        			<?php wp_subscribe_options_text_field('benchmark_user', __('BenchmarkEmail Username', 'wp-subscribe'), 'single_post_form_options'); ?>
		        			<?php wp_subscribe_options_password_field('benchmark_pass', __('BenchmarkEmail Password', 'wp-subscribe'), 'single_post_form_options'); ?>
							<?php wp_subscribe_options_text_field('benchmark_list_name', __('BenchmarkEmail list name', 'wp-subscribe'), 'single_post_form_options'); ?>
						</div><!-- .wp_subscribe_account_details_benchmark -->

						<div class="wp_subscribe_account_details_constantcontact" style="display: none;">
		        			<?php wp_subscribe_options_text_field('constantcontact_api_key', __('Constant Contact API key', 'wp-subscribe'), 'single_post_form_options'); ?>
		        			<?php wp_subscribe_options_text_field('constantcontact_token', __('Constant Contact access token', 'wp-subscribe'), 'single_post_form_options'); ?>
							<?php wp_subscribe_options_text_field('constantcontact_list_id', __('Constant Contact List ID', 'wp-subscribe'), 'single_post_form_options'); ?>
	            			<p class="clear"><a href="http://support2.constantcontact.com/articles/FAQ/1388" target="_blank"><?php _e('Find your API key & access token', 'wp-subscribe'); ?></a> | 
	            			<a href="https://community.constantcontact.com/t5/Getting-Started-with-API-s/How-to-find-the-list-ID-for-your-contact-lists/td-p/185302" target="_blank"><?php _e('Find your list ID', 'wp-subscribe'); ?></a></p>
						</div><!-- .wp_subscribe_account_details_constantcontact -->
						<div class="wp_subscribe_account_details_mailrelay" style="display: none;">
		        			<?php wp_subscribe_options_text_field('mailrelay_api_key', __('MailRelay API key', 'wp-subscribe'), 'single_post_form_options'); ?>
		        			<?php wp_subscribe_options_text_field('mailrelay_host', __('MailRelay host address', 'wp-subscribe'), 'single_post_form_options'); ?>
							<?php wp_subscribe_options_text_field('mailrelay_group_id', __('MailRelay Subscribers Group ID', 'wp-subscribe'), 'single_post_form_options'); ?>
						</div><!-- .wp_subscribe_account_details_mailrelay -->
				    </div><!-- .wp_subscribe_account_details -->
					...
					<div class="wp-subscribe-field wp_subscribe_thanks_page">
			            ...
			            <label>
			                <input id="wp_subscribe_single_post_form_thanks_page" type="checkbox" class="thanks-page-field" name="wp_subscribe_options[single_post_form_options][thanks_page]" value="1" <?php checked($options['single_post_form_options']['thanks_page']); ?>>
			                <?php _e( 'Show Thank You Page after successful subscription', 'wp-subscribe' ); ?>
			            </label>
			            <div class="wp_subscribe_thanks_page_details">
			                <?php wp_subscribe_options_text_field('thanks_page_url', __('Thank You Page URL', 'wp-subscribe'), 'single_post_form_options'); ?>
			            </div>
			        </div>
...
function wp_subscribe_options_password_field($field_id, $label, $group='popup_form_labels') {
    $options = wp_parse_args( get_option( 'wp_subscribe_options' ), wp_subscribe_default_options() );
