...
function wp_subscribe_popup_html($options = null) {
	...
	if ($options['popup_content'] == 'subscribe_form') {
		the_widget( 'wp_subscribe', array(
            ...
            'getresponse_api_key' => $options['popup_form_options']['getresponse_api_key'],
            'getresponse_list_id' => $options['popup_form_options']['getresponse_list_id'],
            'aweber_list_id' => $options['popup_form_options']['aweber_list_id'],
            'mailerlite_api_key' => ( isset( $options['popup_form_options']['mailerlite_api_key'] ) ? $options['popup_form_options']['mailerlite_api_key'] : ''),
            'mailerlite_list_id' => ( isset( $options['popup_form_options']['mailerlite_list_id'] ) ? $options['popup_form_options']['mailerlite_list_id'] : ''),
            'benchmark_user' => ( isset( $options['popup_form_options']['benchmark_user'] ) ? $options['popup_form_options']['benchmark_user'] : ''),
            'benchmark_pass' => ( isset( $options['popup_form_options']['benchmark_pass'] ) ? $options['popup_form_options']['benchmark_pass'] : ''),
            'benchmark_list_name' => ( isset( $options['popup_form_options']['benchmark_list_name'] ) ? $options['popup_form_options']['benchmark_list_name'] : ''),
            'constantcontact_api_key' => ( isset( $options['popup_form_options']['constantcontact_api_key'] ) ? $options['popup_form_options']['constantcontact_api_key'] : ''),
            'constantcontact_token' => ( isset( $options['popup_form_options']['constantcontact_token'] ) ? $options['popup_form_options']['constantcontact_token'] : ''),
            'constantcontact_list_id' => ( isset( $options['popup_form_options']['constantcontact_list_id'] ) ? $options['popup_form_options']['constantcontact_list_id'] : ''),
            'mailrelay_api_key' => ( isset( $options['popup_form_options']['mailrelay_api_key'] ) ? $options['popup_form_options']['mailrelay_api_key'] : ''),
            'mailrelay_host' => ( isset( $options['popup_form_options']['mailrelay_host'] ) ? $options['popup_form_options']['mailrelay_host'] : ''),
            'mailrelay_group_id' => ( isset( $options['popup_form_options']['mailrelay_group_id'] ) ? $options['popup_form_options']['mailrelay_group_id'] : ''),
            'thanks_page' => $options['popup_form_options']['thanks_page'],
            'thanks_page_url' => $options['popup_form_options']['thanks_page_url'],
	...
	function wp_subscribe_single_post_form($content) {
		...
		if (is_singular('post') && is_main_query() && in_the_loop()) {
			...
			$widget = wp_subscribe_get_the_widget( 'wp_subscribe', array(
	            ...
	            'getresponse_api_key' => $options['single_post_form_options']['getresponse_api_key'],
                'getresponse_list_id' => $options['single_post_form_options']['getresponse_list_id'],
	            'aweber_list_id' => $options['single_post_form_options']['aweber_list_id'],
	            'mailerlite_api_key' => ( isset( $options['single_post_form_options']['mailerlite_api_key'] ) ? $options['single_post_form_options']['mailerlite_api_key'] : ''),
	            'mailerlite_list_id' => ( isset( $options['single_post_form_options']['mailerlite_list_id'] ) ? $options['single_post_form_options']['mailerlite_list_id'] : ''),
	            'benchmark_user' => ( isset( $options['single_post_form_options']['benchmark_user'] ) ? $options['single_post_form_options']['benchmark_user'] : ''),
	            'benchmark_pass' => ( isset( $options['single_post_form_options']['benchmark_pass'] ) ? $options['single_post_form_options']['benchmark_pass'] : ''),
	            'benchmark_list_name' => ( isset( $options['single_post_form_options']['benchmark_list_name'] ) ? $options['single_post_form_options']['benchmark_list_name'] : ''),
	            'constantcontact_api_key' => ( isset( $options['single_post_form_options']['constantcontact_api_key'] ) ? $options['single_post_form_options']['constantcontact_api_key'] : ''),
	            'constantcontact_token' => ( isset( $options['single_post_form_options']['constantcontact_token'] ) ? $options['single_post_form_options']['constantcontact_token'] : ''),
	            'constantcontact_list_id' => ( isset( $options['single_post_form_options']['constantcontact_list_id'] ) ? $options['single_post_form_options']['constantcontact_list_id'] : ''),
	            'mailrelay_api_key' => ( isset( $options['single_post_form_options']['mailrelay_api_key'] ) ? $options['single_post_form_options']['mailrelay_api_key'] : ''),
	            'mailrelay_host' => ( isset( $options['single_post_form_options']['mailrelay_host'] ) ? $options['single_post_form_options']['mailrelay_host'] : ''),
	            'mailrelay_group_id' => ( isset( $options['single_post_form_options']['mailrelay_group_id'] ) ? $options['single_post_form_options']['mailrelay_group_id'] : ''),
	            'thanks_page' => $options['single_post_form_options']['thanks_page'],
	            'thanks_page_url' => $options['single_post_form_options']['thanks_page_url'],
...
function wp_subscribe_ajax_validate_subscribe() {
	...
	} elseif (!empty($_POST['mailerlite_email'])) {
		$signup = wp_subscribe_mailerlite_subscribe();
    ...
    } elseif (!empty($_POST['benchmark_email'])) {
		$signup = wp_subscribe_benchmark_subscribe();
	...
	} elseif (!empty($_POST['constantcontact_email'])) {
		$signup = wp_subscribe_constantcontact_subscribe();
    ...
    } elseif (!empty($_POST['mailrelay_email'])) {
		$signup = wp_subscribe_mailrelay_subscribe();
...
function wp_subscribe_mailerlite_subscribe() {
	$options = get_option('wp_subscribe_options');
    $ret = array(
        'success' => false,
        'message' => '',
    ...
    $email = isset($_POST['mailerlite_email']) ? trim($_POST['mailerlite_email']) : '';
    $name = isset($_POST['mailerlite_name']) ? trim($_POST['mailerlite_name']) : '';
    $ml_api_key = null;
    $ml_list_id = null;
    $error_message = '';
    $widget_id = isset($_POST['widget_id']) ? trim($_POST['widget_id']) : '';
    ...
    if (($widget_settings = wp_subscribe_get_widget_settings($widget_id))) {
        $ml_api_key = isset($widget_settings['mailerlite_api_key']) ? $widget_settings['mailerlite_api_key'] : null;
        $ml_list_id = isset($widget_settings['mailerlite_list_id']) ? $widget_settings['mailerlite_list_id'] : null;
        $error_message = isset($widget_settings['error_message']) ? $widget_settings['error_message'] : '';
    }

    if (isset($_POST['from_popup'])) {
    	$ml_api_key = isset( $options['popup_form_options']['mailerlite_api_key'] ) ? $options['popup_form_options']['mailerlite_api_key'] : null;
    	$ml_list_id = isset( $options['popup_form_options']['mailerlite_list_id'] ) ? $options['popup_form_options']['mailerlite_list_id'] : null;
    	$widget_settings = true;
    }

    if (isset($_POST['from_single'])) {
    	$ml_api_key = isset( $options['single_post_form_options']['mailerlite_api_key'] ) ? $options['single_post_form_options']['mailerlite_api_key'] : null;
    	$ml_list_id = isset( $options['single_post_form_options']['mailerlite_list_id'] ) ? $options['single_post_form_options']['mailerlite_list_id'] : null;
    	$widget_settings = true;
    }
	...
	if ($email &&
		...
		if (!class_exists('ML_Subscribers'))
			require_once dirname(__FILE__) . '/mailerlite_rest/ML_Subscribers.php';

		$ML_Subscribers = new ML_Subscribers($ml_api_key);
		...
		$subscriber = array(
	 	...
	 	$response = $ML_Subscribers->setId($ml_list_id)->add($subscriber, 1);
...
function wp_subscribe_benchmark_subscribe() {
	$options = get_option('wp_subscribe_options');
    $ret = array(
        'success' => false,
        'message' => '',
    ...
    $email = isset($_POST['benchmark_email']) ? trim($_POST['benchmark_email']) : '';
    $name = isset($_POST['benchmark_name']) ? trim($_POST['benchmark_name']) : '';
    $bm_user = null;
    $bm_pass = null;
    $bm_list = null;
    $error_message = '';
    ...
    if (($widget_settings = wp_subscribe_get_widget_settings($widget_id))) {
        $bm_user = isset($widget_settings['benchmark_user']) ? $widget_settings['benchmark_user'] : null;
        $bm_pass = isset($widget_settings['benchmark_pass']) ? $widget_settings['benchmark_pass'] : null;
        $bm_list = isset($widget_settings['benchmark_list_name']) ? $widget_settings['benchmark_list_name'] : null;
        $error_message = isset($widget_settings['error_message']) ? $widget_settings['error_message'] : '';
    }

    if (isset($_POST['from_popup'])) {
    	$bm_user = isset( $options['popup_form_options']['benchmark_user']) ? $options['popup_form_options']['benchmark_user'] : null;
        $bm_pass = isset( $options['popup_form_options']['benchmark_pass']) ? $options['popup_form_options']['benchmark_pass'] : null;
    	$bm_list = isset( $options['popup_form_options']['benchmark_list_name'] ) ? $options['popup_form_options']['benchmark_list_name'] : null;
    	$widget_settings = true;
    }

    if (isset($_POST['from_single'])) {
    	$bm_user = isset( $options['single_post_form_options']['benchmark_user']) ? $options['single_post_form_options']['benchmark_user'] : null;
        $bm_pass = isset( $options['single_post_form_options']['benchmark_pass']) ? $options['single_post_form_options']['benchmark_pass'] : null;
    	$bm_list = isset( $options['single_post_form_options']['benchmark_list_name'] ) ? $options['single_post_form_options']['benchmark_list_name'] : null;
    	$widget_settings = true;
    }
	...
	if ($email &&
		...
		$bmApi = new BMEAPI( $bm_user, $bm_pass, 'http://www.benchmarkemail.com/api/1.0');

		$list_id = false;
        $mailListsResp = $bmApi->listGet("", 1, 50, "", "");
        if( $mailListsResp ) {
            foreach ( $mailListsResp as $listItem ) {
                if ( trim( $bm_list ) == trim( $listItem['listname'] ) ) {
                	$list_id = $listItem['id'];
                	break;
                }
            }
        ...
        if ( !$list_id ) {
        	$ret['message'] = __( 'List not found!', 'wp-subscribe' );
        	return $ret;
        }
        ...
        $resp = $bmApi->listAddContacts( $list_id, array( array( 'email' => $email, 'firstname' => $fname, 'lastname' => $lname ) ) );
        
        if ( $resp == 1 ) {
            $ret['success'] = true;
        } else {
            $ret['message'] = __( 'Already subscribed?', 'wp-subscribe' );
        }
...
function wp_subscribe_constantcontact_subscribe() {
	$options = get_option('wp_subscribe_options');
    $ret = array(
        'success' => false,
        'message' => '',
    ...
    $email = isset($_POST['constantcontact_email']) ? trim($_POST['constantcontact_email']) : '';
    $name = isset($_POST['constantcontact_name']) ? trim($_POST['constantcontact_name']) : '';
    $cc_api_key = null;
    $cc_token = null;
    $cc_list_id = null;
    $error_message = '';
    ...
    if (($widget_settings = wp_subscribe_get_widget_settings($widget_id))) {
        $cc_api_key = isset($widget_settings['constantcontact_api_key']) ? $widget_settings['constantcontact_api_key'] : null;
        $cc_token = isset($widget_settings['constantcontact_token']) ? $widget_settings['constantcontact_token'] : null;
        $cc_list_id = isset($widget_settings['constantcontact_list_id']) ? $widget_settings['constantcontact_list_id'] : null;
        $error_message = isset($widget_settings['error_message']) ? $widget_settings['error_message'] : '';
    }

    if (isset($_POST['from_popup'])) {
    	$cc_api_key = isset( $options['popup_form_options']['constantcontact_api_key'] ) ? $options['popup_form_options']['constantcontact_api_key'] : null;
    	$cc_token = isset( $options['popup_form_options']['constantcontact_token'] ) ? $options['popup_form_options']['constantcontact_token'] : null;
    	$cc_list_id = isset( $options['popup_form_options']['constantcontact_list_id'] ) ? $options['popup_form_options']['constantcontact_list_id'] : null;
    	$widget_settings = true;
    }

    if (isset($_POST['from_single'])) {
    	$cc_api_key = isset( $options['single_post_form_options']['constantcontact_api_key'] ) ? $options['single_post_form_options']['constantcontact_api_key'] : null;
    	$cc_token = isset( $options['single_post_form_options']['constantcontact_token'] ) ? $options['single_post_form_options']['constantcontact_token'] : null;
    	$cc_list_id = isset( $options['single_post_form_options']['constantcontact_list_id'] ) ? $options['single_post_form_options']['constantcontact_list_id'] : null;
    	$widget_settings = true;
    }
	...
	if ($email &&
		...
		$apiurl = 'https://api.constantcontact.com/v2/contacts?action_by=ACTION_BY_VISITOR&api_key=' . $cc_api_key;
		...
		if ( !is_wp_error( $raw_response ) ) {
			if ( isset($raw_response['response']['code']) && $raw_response['response']['code'] == 201 ) {
				...
				if ( isset($raw_response['body']) ) {
					...
					$ret['message'] = isset($response_body[0]['error_message']) ? $response_body[0]['error_message'] : '';
				} else {
					$ret['message'] = isset($raw_response['response']['message']) ? $raw_response['response']['message'] : '';
				}
			} else {
				$ret['message'] = __('Error connect to Constant Contact service', 'wp-subscribe' );
			}
		}
...
function wp_subscribe_mailrelay_subscribe() {
	$options = get_option('wp_subscribe_options');
    $ret = array(
        'success' => false,
        'message' => '',
    ...
    $email = isset($_POST['mailrelay_email']) ? trim($_POST['mailrelay_email']) : '';
    $name = isset($_POST['mailrelay_name']) ? trim($_POST['mailrelay_name']) : '';
    $api_key = null;
    $host = null;
    $group_id = null;
    $error_message = '';
    ...
    if (($widget_settings = wp_subscribe_get_widget_settings($widget_id))) {
        $api_key = isset($widget_settings['mailrelay_api_key']) ? $widget_settings['mailrelay_api_key'] : null;
        $host = isset($widget_settings['mailrelay_host']) ? $widget_settings['mailrelay_host'] : null;
        $group_id = isset($widget_settings['mailrelay_group_id']) ? $widget_settings['mailrelay_group_id'] : null;
        $error_message = isset($widget_settings['error_message']) ? $widget_settings['error_message'] : '';
    }

    if (isset($_POST['from_popup'])) {
    	$api_key = isset( $options['popup_form_options']['mailrelay_api_key'] ) ? $options['popup_form_options']['mailrelay_api_key'] : null;
    	$host = isset( $options['popup_form_options']['mailrelay_host'] ) ? $options['popup_form_options']['mailrelay_host'] : null;
    	$group_id = isset( $options['popup_form_options']['mailrelay_group_id'] ) ? $options['popup_form_options']['mailrelay_group_id'] : null;
    	$widget_settings = true;
    }

    if (isset($_POST['from_single'])) {
    	$api_key = isset( $options['single_post_form_options']['mailrelay_api_key'] ) ? $options['single_post_form_options']['mailrelay_api_key'] : null;
    	$host = isset( $options['single_post_form_options']['mailrelay_host'] ) ? $options['single_post_form_options']['mailrelay_host'] : null;
    	$group_id = isset( $options['single_post_form_options']['mailrelay_group_id'] ) ? $options['single_post_form_options']['mailrelay_group_id'] : null;
    	$widget_settings = true;
    }
	...
	if ($email &&
		...
		$http_query = http_build_query( $post_data );
		$url = 'https://'.str_replace( array( 'http://', 'https://' ), '', $host ).'/ccm/admin/api/version/2/&type=json&'.$http_query;
...
function wp_subscribe_shortcode() {
	...
	if ($options['enable_single_post_form']) {
		$widget = wp_subscribe_get_the_widget( 'wp_subscribe', array(
            	...
            	'getresponse_list_id' => $options['single_post_form_options']['getresponse_list_id'],
	            'aweber_list_id' => $options['single_post_form_options']['aweber_list_id'],
	            'mailerlite_api_key' => ( isset( $options['single_post_form_options']['mailerlite_api_key'] ) ? $options['popup_form_options']['mailerlite_api_key'] : ''),
	            'mailerlite_list_id' =>( isset( $options['single_post_form_options']['mailerlite_list_id'] ) ? $options['popup_form_options']['mailerlite_list_id'] : ''),
	            'benchmark_user' => ( isset( $options['single_post_form_options']['benchmark_user'] ) ? $options['popup_form_options']['benchmark_user'] : ''),
	            'benchmark_pass' => ( isset( $options['single_post_form_options']['benchmark_pass'] ) ? $options['popup_form_options']['benchmark_pass'] : ''),
	            'benchmark_list_name' =>( isset( $options['single_post_form_options']['benchmark_list_name'] ) ? $options['popup_form_options']['benchmark_list_name'] : ''),
	            'constantcontact_api_key' => ( isset( $options['single_post_form_options']['constantcontact_api_key'] ) ? $options['popup_form_options']['constantcontact_api_key'] : ''),
	            'constantcontact_token' => ( isset( $options['single_post_form_options']['constantcontact_token'] ) ? $options['popup_form_options']['constantcontact_token'] : ''),
	            'constantcontact_list_id' =>( isset( $options['single_post_form_options']['constantcontact_list_id'] ) ? $options['popup_form_options']['constantcontact_list_id'] : ''),
	            'mailrelay_api_key' => ( isset( $options['single_post_form_options']['mailrelay_api_key'] ) ? $options['popup_form_options']['mailrelay_api_key'] : ''),
	            'mailrelay_host' => ( isset( $options['single_post_form_options']['mailrelay_host'] ) ? $options['popup_form_options']['mailrelay_host'] : ''),
	            'mailrelay_group_id' =>( isset( $options['single_post_form_options']['mailrelay_group_id'] ) ? $options['popup_form_options']['mailrelay_group_id'] : ''),
	            'thanks_page' => $options['single_post_form_options']['thanks_page'],
	            'thanks_page_url' => $options['single_post_form_options']['thanks_page_url'],
